...
export default function Page() {
  return (
    <>
      <section className="hidden md:flex flex-col items-center justify-center gap-10 w-7xl mx-auto py-8 my-8">
        <h1
      ...
      {/* Mobile */}
      <section className="flex md:hidden flex-col items-center justify-center gap-10 w-full mx-auto px-2 py-8 my-8">
        <h1
          className={`flex items-center justify-center gap-3 text-xs text-center text-black ${AlfaSlabOne.className} bg-primary/75 px-4 py-2 rounded-full z-10`}
        >
          <Image src="/icons/worker.svg" alt="Worker" width={30} height={30} />
          <Typewriter
            onInit={(typewriter) => {
              typewriter
                //   .typeString("Gran Feria de capacitación")
